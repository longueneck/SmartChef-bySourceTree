...
//Cria o protocolo
 ...
 protocol BreakfastScreenProtocol:AnyObject{
    func actionBackButton() //Cria a funcao
}

class BreakfastScreen: UIView {
    
    weak private var delegate:BreakfastScreenProtocol?
    
    func delegate(delegate:BreakfastScreenProtocol){
    ...
    lazy var imagePageType: UIImageView = {
        ...
        imageType.image = UIImage(named: "cafe")
    ...
    lazy var backButton: UIButton = {
        ...
        //Passo 2 --> Cria o target e coloca o metodo criado la embaixo
    ...
    lazy var collectionBreakfast: UICollectionView = {
        ...
        collection.register(BreakfastCollectionViewCell.self, forCellWithReuseIdentifier: BreakfastCollectionViewCell.identifier)
    ...
    lazy var stackRecipes: BreakfastStackView = {
        let stack = BreakfastStackView()
    ...
    public func collectionDelegate(delegate: UICollectionViewDelegate, dataSource: UICollectionViewDataSource){
        collectionBreakfast.delegate = delegate
        collectionBreakfast.dataSource = dataSource
    }
    ...
    private func addViews(){
        ...
        self.addSubview(self.collectionBreakfast)
        self.addSubview(self.stackRecipes)
        
    }
    
    //Criar acao para proxima tela
    //Passo 1 --> Criar o metodo para chamar dentro do terget do botao
    ...
    //MARK: ABAIXAR O TECLADO --> Configurando botao RETURN do teclado
    ...
    private func addConstraints(){
        NSLayoutConstraint.activate([
            ...
            imagePageType.heightAnchor.constraint(equalToConstant: 25),
            imagePageType.widthAnchor.constraint(equalToConstant: 25),
            ...
            collectionBreakfast.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 25),
            collectionBreakfast.trailingAnchor.constraint(equalTo: self.trailingAnchor, constant: -25),
            collectionBreakfast.topAnchor.constraint(equalTo: lbMostVisited.bottomAnchor, constant:10),
            collectionBreakfast.heightAnchor.constraint(equalToConstant: 150),
            
            lbFriends.leadingAnchor.constraint(equalTo: self.leadingAnchor, constant: 30),
            lbFriends.topAnchor.constraint(equalTo: collectionBreakfast.bottomAnchor, constant: 25),
