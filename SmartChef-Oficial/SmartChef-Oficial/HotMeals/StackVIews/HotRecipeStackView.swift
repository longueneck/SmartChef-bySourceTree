...
class HotRecipeStackView: UIStackView {
    ...
    lazy var hotRecipe1: UIButton = {
        ...
        let buttonImage = UIImage(named: StringMagica.juiceImageButton)
    ...
    lazy var hotRecipe2: UIButton = {
        ...
        let buttonImage = UIImage(named: StringMagica.teaImageButton)
    ...
    lazy var hotRecipe3: UIButton = {
        ...
        let buttonImage = UIImage(named: StringMagica.expressImage)
    ...
    lazy var hotRecipe4: UIButton = {
        ...
        let buttonImage = UIImage(named: StringMagica.refrigeratorImageButton)
