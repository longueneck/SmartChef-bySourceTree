...
protocol LunchScreenProtocol: AnyObject{
    func actionBackButton()
}

class LunchScreen: UIView {
    
    weak private var delegate:LunchScreenProtocol?
    
    func delegate(delegate:LunchScreenProtocol){
    ...
    lazy var collectionHot: UICollectionView = {
        ...
        collection.register(LunchCollectionViewCell.self, forCellWithReuseIdentifier: LunchCollectionViewCell.identifier)
